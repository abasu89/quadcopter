...
class PhysicsSim():
    def __init__(self, init_pose=None, init_velocities=None, init_angle_velocities=None, runtime=5.): #takes in starting pose aspects to create instance
        # allocate initial conditions (or inputs) to class attributes
        self.init_pose = init_pose
        self.init_velocities = init_velocities
        self.init_angle_velocities = init_angle_velocities
        self.runtime = runtime
        
        # specify various physical parameters and allocate them to class attributes
